...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="{{ asset('dist/index.html') }}" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">LC Int MAga</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
        ...
        <footer class="app-footer">
            <!--begin::To the end-->
            <div class="float-end d-none d-sm-inline">Всё, что вы хотите</div>
            <!--end::To the end-->
            <!--begin::Copyright-->
            <strong>
                Авторское право &copy; 2014-{{ now() }}&nbsp;
                <a href="{{ route('main.index') }}" class="text-decoration-none">Интернет-магазин</a>.
            </strong>
            Все права защищены.
            <!--end::Copyright-->
        </footer>
    ...
    <script src="https://cdn.jsdelivr.net/npm/apexcharts@3.37.1/dist/apexcharts.min.js"
        integrity="sha256-+vh8GkaU7C9/wbSLIcwq82tQ2wTf44aOHA8HlBMwRI8=" crossorigin="anonymous"></script>  BANNED --}}
    <!-- ChartJS -->
    ...
    <script>
        $(function() {
            $('.tags').select2({
                theme: 'default' // или 'bootstrap4', если подключишь тему
            });
            $('.colors').select2({
                theme: 'default' // или 'bootstrap4', если подключишь тему
            });
