              ...
              <div class="product-categories-one__inner">
                <ul>
                  ...
                  <li>
                    <a href="#0" class="img-box">
                      <div class="inner">
                        <img src="/assets/images/shop/product-categories-v1-img2.png" alt="" />
                      </div>
                    </a>
                    <div class="title">
                      <a href="#0">
                  ...
                  <li>
                    <a href="#0" class="img-box">
                      <div class="inner">
                        <img src="/assets/images/shop/product-categories-v1-img3.png" alt="" />
                      </div>
                    </a>
                    <div class="title">
                      <a href="#0">
                  ...
                  <li>
                    <a href="#0" class="img-box">
                      <div class="inner">
                        <img src="/assets/images/shop/product-categories-v1-img4.png" alt="" />
                      </div>
                    </a>
                    <div class="title">
                      <a href="#0">
                  ...
                  <li>
                    <a href="#0" class="img-box">
                      <div class="inner">
                        <img src="/assets/images/shop/product-categories-v1-img5.png" alt="" />
                      </div>
                    </a>
                    <div class="title">
                      <a href="#0">
                  ...
                  <li>
                    <a href="#0" class="img-box">
                      <div class="inner">
                        <img src="/assets/images/shop/product-categories-v1-img6.png" alt="" />
                      </div>
                    </a>
                    <div class="title">
                      <a href="#0">
                ...
                <div class="sidebar-holder">
                      ...
                      <form>
                        ...
                        >
                          <input
                            ...
                            :value="category.id"
                            type="checkbox"
                            :id="`bedroom${category.id}`"
                          />
                          <label :for="`bedroom${category.id}`">{{ category.title }}</label>
                        </div>
                      </form>
                    </div>
                  </div>
                    ...
                    <ul class="color-option">
                      <li v-for="color in filterList.colors" :key="color.id">
                        <a
                          ...
                          @click.prevent="addColors(color.id)"
                        >
                  ...
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                    ...
                    <div class="slider-box">
                      ...
                      <button @click.prevent="getFilteringValue()" class="filterbtn" type="submit">
                        Filter
                      </button>
                    </div>
                  </div>
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated pb-0 border-bottom-0">
                    ...
                    <ul class="popular-tag">
                      <li v-for="tag in filterList.tags" :key="tag.id">
                        <a @click.prevent="addTags(tag.id)" href="#0">{{ tag.title }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="color-varient">
                                        <template
                                          v-for="(groupProduct, index) in product.group_products"
                                          :key="index"
                                        >
                                          <a
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                                  ...
                                  <div class="col-lg-6">
                                    <div class="popup-right-content">
                                      ...
                                      <div class="ratting">
                                        <i class="flaticon-star"></i> <i class="flaticon-star"></i>
                                        <i class="flaticon-star"></i> <i class="flaticon-star"></i>
                                        <i class="flaticon-star"></i> <span>(123)</span>
                                      </div>
                            ...
                            <div class="product-grid-two-content text-center">
                              ...
                              <p class="text">
                                Typi non habent claritatem insitam usus legentis qui facit eorum
                                claritatem Investigationes demonstraverunt lectores legere mele lius
                                quod legunt saepius Claritas est etiam processus a capitalize on low
                                hanging
                              </p>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img">
                              <a href="shop-details-2.html" class="d-block">
                                <img src="/assets/images/home-three/products-3.jpg" alt="" />
                              </a>
                              <div class="products-grid-one__badge-box">
                                <span class="bg_base badge new">New</span>
                              </div>
                        ...
                        <div class="col-12">
                          <div class="product-grid-two list mt-30">
                            <div class="product-grid-two__img">
                              <a href="shop-details-2.html" class="d-block">
                                <img src="/assets/images/home-three/productss3-1.jpg" alt="" />
                              </a>
                            </div>
              ...
              <div class="row">
                <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                  <ul class="pagination text-center">
                    ...
                    <li v-for="link in pagination.links" :key="link.id" style="display: flex">
                      <template
                        v-if="
                          Number(link.label) &&
                      ...
                      <template v-if="Math.abs(pagination.current_page - link.label) == 3">
                        <a>...</a>
                      </template>
                    </li>
...
export default {
  ...
  data() {
    return {
      ...
      //for getting data for filter fields
      filterList: [],
  ...
  methods: {
    ...
    //filtering actions start
    addColors(id) {
      if (!this.colors.includes(id)) this.colors.push(id)
      else this.colors = this.colors.filter((colorId) => colorId !== id)
    },
    addTags(id) {
      if (!this.tags.includes(id)) this.tags.push(id)
      else this.tags = this.tags.filter((tagId) => tagId !== id)
    },
    getFilteringValue() {
      let values = $('#price-range').slider('values')
      this.prices = [{ min: values[0] }, { max: values[1] }]
      this.getProducts()
    },
      ...
      api
        ...
        .then((result) => {
          ...
          if ($('#price-range').length) {
            $('#price-range').slider({
              range: true,
              min: this.filterList.price.minPrice,
              max: this.filterList.price.maxPrice,
              values: [this.filterList.price.minPrice, this.filterList.price.maxPrice],
