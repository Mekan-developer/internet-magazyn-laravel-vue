            ...
            <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
              <div class="single-product-box one">
                <div class="big-product single-product-one slider-for">
                  ...
                  <div>
                    <div class="single-item">
                      <img src="/assets/images/shop/products-img3.jpg" alt="" />
                      <div class="ptag"><span class="one">-20% </span></div>
                      <a href="#0" class="love"> <i class="flaticon-like"></i> </a>
                    </div>
                  </div>
                  ...
                  <div class="product-slicknav single-product-one-nav slider-nav">
                    <div>
                      <span class="single-item">
                        <img src="/assets/images/shop/shop-details-top-img-1.png" alt="" />
                      </span>
                    </div>
                    <div>
                      <span class="single-item">
                        <img src="/assets/images/shop/shop-details-top-img-2.png" alt="" />
                      </span>
                    </div>
                    <div>
                      <span class="single-item">
                        <img src="/assets/images/shop/shop-details-top-img-3.png" alt="" />
                      </span>
                    </div>
                    <div>
                      <span class="single-item">
              ...
              <div class="shop-details-top-right">
                <div class="shop-details-top-right-content-box">
                  ...
                  <p class="shop-details-top-product-delivery">
                    This product estimated delivery between <span>Wednesday 27 October</span> <br />
              ...
              >
                <div class="product-drescription">
                  ...
                  <p>
                    ...
                    ethical functionalities via empowered scenarios. Phosfluorescently restore
                    highly efficient opportunities and client-focused infomediaries.
                    Enthusiastically transition multidisciplinary outside the box thinking without
                    premium networks. Progressive supply clicks-and-mortar human capital through
                    enterprise-wide web services. Objectivey bester provide access to extensible
                    processes better than more qulification dumber there stoaling through 24/365
                    solutions.
                  </p>
                ...
                <div class="product-drescription">
                  <div class="review-single pt-0 hed">
                    <div class="ratting">
                      ...
                      <i class="flaticon-star-1"></i> <i class="flaticon-star-1"></i>
                      <i class="flaticon-star-1"></i> <span class="ps-2">BASED ON 100 REVIEW</span>
                    </div>
                  </div>
                            ...
                            <div class="popup-product-thumb-box">
                              <ul>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#tab7">
                                    <img src="/assets/images/shop/products-img1.jpg" alt="img" />
                                  </a>
                                </li>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#tab8">
                                    <img src="/assets/images/shop/products-img2.jpg" alt="img" />
                                  </a>
                                </li>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#tab9">
                                    <img src="/assets/images/shop/products-img3.jpg" alt="img" />
                                  </a>
                                </li>
                              </ul>
                            </div>
                          ...
                          <div class="tabs">
                            <div class="popup-product-thumb-box">
                              <ul>
                                ...
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#tab888">
                                    <img src="/assets/images/shop/products-img4.jpg" alt="img" />
                                  </a>
                                </li>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#tab999">
                                    <img src="/assets/images/shop/products-img5.jpg" alt="img" />
                                  </a>
                                </li>
                              </ul>
                            </div>
                            <div class="popup-product-main-image-box">
                              ...
                              <div id="tab999" class="tab-item popup-product-image">
                                <div class="popup-product-single-image">
                                  <img src="/assets/images/shop/products-img6.jpg" alt="img" />
                                </div>
                              </div>
                              <button class="prev"><i class="flaticon-back"></i></button>
                              <button class="next"><i class="flaticon-next"></i></button>
                          ...
                          <div class="tabs">
                            <div class="popup-product-thumb-box">
                              <ul>
                                ...
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#tab99999">
                                    <img src="/assets/images/shop/products-img7.jpg" alt="img" />
                                  </a>
                                </li>
                              </ul>
                            </div>
                          ...
                          <div class="tabs">
                            <div class="popup-product-thumb-box">
                              <ul>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#ttab111">
                                    <img src="/assets/images/shop/products-img9.jpg" alt="img" />
                                  </a>
                                </li>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#ttab222">
                                    <img src="/assets/images/shop/products-img10.jpg" alt="img" />
                                  </a>
                                </li>
                                <li class="tab-nav popup-product-thumb">
                                  <a href="#ttab333">
                                    <img src="/assets/images/shop/products-img11.jpg" alt="img" />
                                  </a>
                                </li>
                              </ul>
                            </div>
  ...
  methods: {
    getProduct() {
      api.get(`products/${this.$route.params.id}`).then((res) => {
        ;((this.product = res.data.data), console.log(res.data.data))
      })
    },
  },
}
