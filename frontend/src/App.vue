            ...
            <div class="mobile-menu">
              ...
              <div class="mobile-menu__sidebar-menu">
                <div class="menu-closer two">
                  <span> Close Menu</span> <span class="cross"><i class="flaticon-cross"></i></span>
                </div>
                  ...
                  <div class="col-12">
                    <div class="some-info">
                      <p class="d-flex align-items-center">
                        <span class="icon"> <i class="flaticon-power"></i> </span> Welcome to Karte
                        Online Shop
                      </p>
                  ...
                  <div class="col-12">
                    <div class="mega-menu-default mega-menu d-lg-block d-none">
                      <div class="d-flex align-items-center justify-content-between">
                        <nav>
                          <ul
                            class="page-dropdown-menu d-flex align-items-center justify-content-start"
                          >
                            <li class="dropdown-list">
                              <router-link to="/">
                                <span>Home</span>
                          ...
                          <ul class="main-menu__widge-box d-flex align-items-center">
                            ...
                            <li class="d-lg-block d-none">
                              <a href="wishlist.html" class="number"
                                ><i class="flaticon-heart"></i> <span class="count">(2)</span>
                              </a>
                            </li>
                            <li class="cartm">
                              <a href="#0" class="number cart-icon">
                                <i class="flaticon-shopping-cart"></i
                                ><span class="count">{{ orderQty }}</span>
                              </a>
                            </li>
                          </ul>
                        </div>
...
export default {
  name: 'App',
  // 1️⃣ Подписка на событие change123
